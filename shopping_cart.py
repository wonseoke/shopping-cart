...
while True:
    ...
    if selected_id == "DONE":
        ...
        print("Invalid product identifier. Either input DONE or a valid product identifier")
...
print("Trader Wesley's")

#A grocery store phone number and/or website URL and/or address of choice
print("201-111-1111")
print("wskwsk.squarespace.com")
print("8282 Fastest Road, Edgeoftomorrow, FF 12345")
print("---------------------------------")
